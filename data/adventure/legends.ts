...
// ============================================================
// 野生の「おためし」遭遇(祠とは別に、フィールドにまれに現れる)
// ============================================================

/** プレイヤーへ近づく速さ(m/秒)。巨大なので、下っ端よりゆったり動く。 */
export const LEGEND_WANDER_SPEED = 1.0;
/** これより近づくと自動でバトルになる距離。巨大な見た目に合わせて広めにとる。 */
export const LEGEND_WANDER_CAPTURE_RANGE = 4.0;
